...
mbti_data = {
    ...
    'ISTP': {
        '특징': '개이기적이고 혼자만의 시간을 즐김. 자신의 시간을 침범하는 사람을 혐오하며 혼자 있지않으면 불안 증세를 느낌. ex) 남규현-최민석, 유태영-하진웅  '
               '코가 크고 어깨가 좁으며 대략 한뺨 두마디 정도의 어깨를 소유해 길고양이들만의 통로를 잘지나감   '
               '방밸을 하는 것을 싫어하는 척하면서도 내심 좋아하고 있음',
